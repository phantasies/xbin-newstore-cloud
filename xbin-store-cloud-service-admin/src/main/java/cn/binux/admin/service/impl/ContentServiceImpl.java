...
public class ContentServiceImpl implements ContentService {
    ...
    public Map<String, Object> getCategoryList(Integer sEcho, Integer iDisplayStart,
    ...
    @Override
    @ApiOperation("保存二级分类")
    @ApiImplicitParams({ @ApiImplicitParam(name = "TbCategorySecondary", value = "", required = true, dataType = "TbCategorySecondary"), })
    @ApiResponses({ @ApiResponse(code = 200, message = "Successful — 请求已完成"),
        @ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"),
        @ApiResponse(code = 401, message = "未授权客户机访问数据"),
        @ApiResponse(code = 404, message = "服务器找不到给定的资源；文档不存在"),
