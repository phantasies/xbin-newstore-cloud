package cn.binux.user.service;

import cn.binux.pojo.TbUser;
import cn.binux.user.service.hystrix.UserServiceHystrix;
...
@FeignClient(value = "xbin-store-cloud-service-user",fallback = UserServiceHystrix.class)
