package cn.binux.homepage.service.impl;
 ...
 * @create 2017-05-04
 */
@Api(value = "API - HomepageContentServiceImpl", description = "首页操作")
@RestController
@RefreshScope
public class HomepageContentServiceImpl implements HomepageContentService {

    private static Logger logger = Logger.getLogger(HomepageContentServiceImpl.class);
    ...
    @Override
    @ApiOperation("获取首页广告")
    @ApiImplicitParams({ @ApiImplicitParam(name = "bigAdIndex", value = "", required = true, dataType = "Long"), })
    ...
    public List<TbContent> getContentByCid(Long bigAdIndex) {
        ...
        condition.put("categoryId", bigAdIndex);
        List<TbContent> list = contentMapper.selectByCondition(condition);
