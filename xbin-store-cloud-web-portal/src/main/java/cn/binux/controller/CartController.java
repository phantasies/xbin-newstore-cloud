...
public class CartController {
    ...
    @RequestMapping("/add")
    public String addCart(Long pid, Integer pcount, HttpServletRequest request,
    ...
    public @ResponseBody XbinResult decreOrIncre(Long pid, Integer pcount, Integer type,
